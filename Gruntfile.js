module.exports = grunt => {
    ...
    grunt.registerTask( 'build-ie11', [ 'js', 'shell:ie11polyfill', 'shell:babel', 'shell:browserify' ] );
    ...
    grunt.registerTask( 'develop-ie11', [ 'env:develop', 'i18next', 'build-ie11', 'css', 'concurrent:develop' ] );
